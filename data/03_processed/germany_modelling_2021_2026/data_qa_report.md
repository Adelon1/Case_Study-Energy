...
- Dataset folder: `germany_modelling_2021_2026`
- Stage-3 CSV: `data/03_processed/germany_modelling_2021_2026/germany_model_dataset.csv`
- Feature CSV: `data/03_processed/germany_modelling_2021_2026/germany_model_features.csv`
...
- Requested local delivery window: `2021-01-01 00:00:00+01:00` to `2026-01-02 00:00:00+01:00`; end is exclusive.
- API UTC window: `202012312300` to `202601012300`
- Final timestamp UTC range: `2020-12-31 23:00:00+00:00 to 2026-01-01 22:00:00+00:00`
- Final timestamp local range: `2021-01-01 00:00:00+01:00 to 2026-01-01 23:00:00+01:00`
...
| --- | --- |
| day_ahead_prices | 0 days 01:00:00 |
...
- Expected hourly rows: `43848`
- Actual hourly rows: `43848`
- Coverage: `100.0%`
...
| --- | --- | --- | --- |
| load_forecast_mw | 50 | 50 | 0 |
| solar_forecast_mw | 3 | 3 | 0 |
| wind_onshore_forecast_mw | 3 | 3 | 0 |
