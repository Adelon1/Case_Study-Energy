...
| `data/`, `models/`, `outputs/` | Generated artifacts; inspect them locally, but regenerate rather than editing by hand. |
...
data/        01_raw/ 02_interim/ 03_processed/   (ignored; regenerated by make reproduce)
models/      validation runs and saved artifacts per model (ignored; regenerated)
outputs/     human-facing forecast views, plots, reports, and commentary (ignored; regenerated)
```
...
- `data/`, `models/`, and `outputs/` are ignored because they are reproducible generated artifacts.
